...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../res/wam/index.js":[function(require,module,exports) {
...
function timer() {
  ...
  if (timerSec == 0) {
    ...
    for (var _i = 1; _i <= 16; _i++) {
      document.getElementById(_i).style.backgroundImage = '';
    }
  }
}
...
function spawnMole() {
  ...
  var cellToSpawn = document.getElementById(rand);
...
function timeOutDeleteMole(_x) {
  return _timeOutDeleteMole.apply(this, arguments);
}

function _timeOutDeleteMole() {
  _timeOutDeleteMole = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(cellToDelete) {
    var promise;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            promise = new Promise(function (resolve, reject) {
              setTimeout(function () {
                return resolve(cellToDelete.style.backgroundImage = '');
...
function restartGame() {
  for (var _i2 = 1; _i2 <= 16; _i2++) {
    document.getElementById(_i2).style.backgroundImage = '';
  }
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../res/wam/index.js"], null)
//# sourceMappingURL=/wam.9c9614f8.js.map